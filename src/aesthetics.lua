...
Aesthetics.backgrounds = {
    ...
    {id="deepsea",     name="Deep Sea",       desc="Drifting currents and bubbles.",                 hint="Global Rep >= 60",                 unlock=function(p) return (p.globalRep or 0) >= 60 end},
    ...
    {id="forest",      name="Mystic Forest",   desc="Silhouetted pines with drifting fireflies.",     hint="Global Rep >= 80",                 unlock=function(p) return (p.globalRep or 0) >= 80 end},
